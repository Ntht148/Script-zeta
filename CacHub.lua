...
local Tabs = {
    infor = Window:AddTab({ Title = "Infor", Icon = "" }),
    Home = Window:AddTab({ Title = "Status", Icon = "" }),
    Main = Window:AddTab({ Title = "Gerenal", Icon = "home" }),
    st = Window:AddTab({ Title = "Stack Auto Farm", Icon = "" }),
...
ImageButton.Image = "http://www.roblox.com/asset/?id=72664553428234"
...
local function playSound()
    ...
    sound.SoundId = "rbxassetid://(Ảnh Asset id để làm cái logo)"
    sound.Volume = 10
    sound:Play()
end
